				...
				<main className={styles.main}>
					...
					<div className={styles.main__text}>
						<h1 className={styles.main__title}>
							Разработка сайтов<br /> и web-приложений
						</h1>

						<p className={styles.main__description}>
							Разрабатываем передовые вебсайты и приложения
							на React.JS и Next.JS.
						</p>
					</div>

					<div className={styles.main__imgBlock}>
						<Image className={styles.main__image} src="/notebook.png" alt="notebook" width={587.78} height={400} />
